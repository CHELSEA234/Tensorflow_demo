...
class RNN(object):
    ...
    def __init__(self, config):
        ...
        ## QUESTION: DOES THE RESHAPE CHANGE THE ORDER OF TENSOR?????
        ## TENSOR GOES THROUGH NETWORK, USING DIFFERENT RESHAPE HERE
    ...
    def _built_RNN(self):
        ...
        with tf.name_scope('RNN'):
            ...
            with tf.variable_scope('cell'):
                ...
                # print (l_in_y[:, :, :].get_shape())     # (20, 20, 11)
                for t in range(self._time_steps):
                    if t > 0: tf.get_variable_scope().reuse_variables()   
                    # print (l_in_y[:, t, :].get_shape())     # (20, 11)
