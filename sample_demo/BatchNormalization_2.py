...
# GX: NOTE: placeholder here is global variable, which can be accessed anywhere in this code.
# even inner class/ instance

# How to use a class to make a net
class NN(object):
    def __init__(self, batch_normalization=False):
        ...
        # hidden layers
        for i in range(N_HIDDEN):  # adding hidden layers, using its own function
