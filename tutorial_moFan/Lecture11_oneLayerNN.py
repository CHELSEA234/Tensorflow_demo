...
for i in range(1000):
    # training
    sess.run(train_step, feed_dict={xs: x_data, ys: y_data})    #you call "fun" train_step, then loss, then l1. the parameters you need is xs and ys
    if i % 50 == 0:
        # to see the step improvement
        print(sess.run(loss, feed_dict={xs: x_data, ys: y_data}))   #print out loss, you put your pointer on it, the parameters you need is xs and ys
